...
% - KB, voler ragionare tulle eccezioni, soluzione basata sull'operatore di tipicalità;
...
\begin{figure}[htp]
\begin{center}\includegraphics[scale=1.00]{img/union_rule.png}\end{center} %%FIXME: ripristinare l'albero!
%	\begin{prooftree}
%		\rootAtTop
...
\begin{figure}[htp]
\begin{center}\includegraphics[scale=1.00]{img/box_rule.png}\end{center} %%FIXME: ripristinare l'albero!
%\footnotesize
%\begin{prooftree}
%	\rootAtTop
