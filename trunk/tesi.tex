...
%%% two phase calculus
%%%TODO: check!!!
$\nuovoc$ is designed as a two--phase calculus so, intuitively, there is no need for the first phase of the calculus to wait the result of the elaboration of a branch by the second phase before launching another one instance.
...
If the main machine reaches the end of its computation, it doesn't have to wait the ``answers'' of the parallel branches in every case:
\begin{itemize}
