...
%\documentclass[oneside,a4paper,11pt,titlepage]{book}
...
\newenvironment{ultimissimi}{\color{black}}{\color{black}} %Modifiche reviewer cattivo
\newenvironment{rosso}{\color{black}}{\color{black}} %Modifiche reviewer cattivo
\newenvironment{blu}{\color{black}}{\color{black}} %Modifiche reviewer buono e aggiunta di R
...
%%%TODO: TBox: definire bene, con inclusioni
...
%%TODO: mettere un disegnino, col modello, ad esempio animali,...
...
%%%TODO: mettere a posto, tenendosi più sul generale (introdurre a parole)
...
\begin{figure}[htp]
\begin{prooftree}
\AxiomC{$\langle S\,|\,U,\,C\sqsubseteq D^L \rangle$}
\RightLabel{$(\sqsubseteq)$}
\UnaryInfC{$\langle S, \,x : \neg C \sqcup D\,|\,U,\,C\sqsubseteq D^{L, x} \rangle$}
\end{prooftree}
...
%%TODO: mettere il codice significativo!
...
\chapter{An example of execution}
\begin{enumerate}
